...
extern const std::map<std::string, TokenType> static_word_token_types;
extern const std::map<char, TokenType> bracket_token_types;
extern const std::map<char, TokenType> single_symbol_token_types;

extern const std::map<TokenType, std::string> token_names;
...
struct Token
{
    ...
    /**
     * Returns true if an instance of Token has TOK_0 type.
     */
 ...
 */
Token token_create(TokenType tok, InStringPosition pos, std::string val = "");
